...
def show_worker_menu(chat_id: str, worker_data):
    """Muestra menú para trabajador ya registrado con UX/UI mejorada"""
    ...
    markup.add(
        types.InlineKeyboardButton(
            f"{Icons.ONLINE if not is_online else Icons.OFFLINE} {'Conectarme' if not is_online else 'Desconectarme'}",
